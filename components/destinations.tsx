...
export const allDestinations: Destination[] = [
  ...
  },
  {
    ...
    category: "Mountains",
    description:
      "The former summer capital of British India, Shimla charms with its colonial architecture, pine-clad slopes, and sweeping Himalayan vistas. A timeless hill station that blends old-world elegance with mountain serenity.",
    highlights: [
      "Heritage walk along the Mall Road and Ridge",
      "Toy train ride on the Kalka–Shimla railway",
      "Sunset views from Jakhoo Hill temple",
      "Day trip to Kufri and the apple orchards",
      "Colonial-era Christ Church and Scandal Point",
      "Forest trek to Chadwick Falls",
    ],
    duration: "5 nights",
  ...
  },
  {
    ...
    category: "Mountains",
    description:
      "Nestled around the emerald Naini Lake and ringed by forested Kumaon hills, Nainital is a tranquil lakeside retreat. Boating, ropeways, and crisp mountain air make it one of India's most beloved hill stations.",
    highlights: [
      "Sunrise boat ride on Naini Lake",
      "Aerial ropeway to Snow View Point",
      "Browse the bustling Mall Road bazaar",
      "Panoramic vistas from Tiffin Top",
      "Visit the historic Naina Devi Temple",
      "Day trip to the seven lakes of Sattal",
    ],
    duration: "4 nights",
  ...
  },
  {
    ...
    category: "Mountains",
    description:
      "Known as the Queen of the Hills, Mussoorie offers misty ridgelines, cascading waterfalls, and grand views of the Doon Valley and snow-capped Himalayas. A romantic hill retreat steeped in colonial charm.",
    highlights: [
      "Cable car to Gun Hill viewpoint",
      "Stroll the scenic Camel's Back Road",
      "Refreshing visit to Kempty Falls",
      "Snow-peak views from Lal Tibba",
      "Quaint cafes and shops on the Mall",
      "Day trip to Landour's colonial lanes",
    ],
    duration: "4 nights",
